...
function hasNaturalReaderJapanese(value){
  ...
  // A persuasive Japanese sentence should contain kana, not only a kanji string.
  // This rejects common mixed-language/Chinese-like fragments without product-specific rules.
