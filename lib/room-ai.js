...
function validateSellingPoint(point,itemName,itemCaption){
  ...
  const valid=Boolean(text&&evidenceValid&&textEvidenceValid&&numbersValid&&meaningSupported&&!promoRisk&&!claimRisk);
  return {
    text,source,evidence,valid,evidenceValid,textEvidenceValid,numbersValid,meaningSupported,
