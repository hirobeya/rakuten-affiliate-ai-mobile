...
function validateSellingPoint(point,itemName,itemCaption){
  ...
  const valid=Boolean(text&&evidenceValid&&numbersValid&&meaningSupported&&!promoRisk&&!claimRisk);
  return {
    text,source,evidence,valid,evidenceValid,numbersValid,meaningSupported,
