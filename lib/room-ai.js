...
function validateProductType(productType,itemName,itemCaption){
  ...
  return {
    ...
    valid:Boolean(value&&evidenceValid&&textEvidenceValid&&boundaryValid&&numbersValid&&meaningSupported&&!promoRisk&&!claimRisk&&!genericProductTypeRisk&&!productTypeStructureRisk),
    evidenceValid,
    textEvidenceValid,
    numbersValid,
    meaningSupported,
