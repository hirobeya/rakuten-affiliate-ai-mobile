(function(root){
  ...
  const ROLE_PATTERNS={
    ...
    feature:[
      /コードレス|充電式|折りたたみ|折り畳み|防水|撥水|洗える|丸洗い|食洗機対応|乾燥機対応|ドラム式対応|USB-?C|Type-?C|LEDライト(?:付き|付)?|コンパクト|スリム|薄型|滑り止め(?:加工)?|取替式|取り替え式|取替え式|使い捨て|伸縮|ロング|マイクロファイバー|吸水|速乾|HEPA|両面|低反発|高反発|日本製|急速充電|ワイヤレス充電|UPS機能|ソーラーパネルセット|メッシュ|特大サイズ|洗濯機対応/gi
    ]
  };
  ...
  const PRODUCT_NOUN_PATTERNS=[
    ...
    /収納ベンチ|ベンチボックス|ランドリーバスケット|洗濯かご|ランドリーボックス|キッチンワゴン|収納ワゴン|収納バスケット|ランドリーラック/g,
    /モバイルバッテリー用[^\s]{0,16}(?:ケース|ポーチ|カバー)|Power\s*Bank\s*(?:Case|ケース|ポーチ|カバー)|PowerBank\s*(?:Case|ケース|ポーチ|カバー)/gi,
    /バイクグローブ|バイク\s*グローブ|バイク用グローブ|バイク手袋|オートバイグローブ|ライディンググローブ|ライダーグローブ|レーシンググローブ|MOTOグローブ/gi,
    /加湿器|電気ケトル|USBハブ|折りたたみ傘|ペット給水器|フライパン|水筒|枕|まな板|Tシャツ|シートカバー|ノートPCスタンド|ラグ|エコバッグ|フロアマット|スマホスタンド|ティッシュケース/g,
  ...
  const PRODUCT_FAMILY_RULES=[
    ...
    {family:'storage.basket',re:/収納バスケット/},
    {family:'laundry.rack',re:/ランドリーラック/},
    {family:'apparel.tshirt',re:/Tシャツ/i},
    {family:'motorcycle.riding_glove',re:/バイクグローブ|バイク\s*グローブ|バイク用グローブ|バイク手袋|オートバイグローブ|ライディンググローブ|ライダーグローブ|レーシンググローブ|MOTOグローブ/i},
    {family:'auto.seat_cover',re:/シートカバー/},
    {family:'pc.laptop_stand',re:/ノートPCスタンド|ラップトップスタンド/i},
    {family:'home.rug',re:/ラグ/},
    {family:'bag.eco',re:/エコバッグ/},
    {family:'auto.floor_mat',re:/フロアマット/},
    {family:'mobile.stand',re:/スマホスタンド/},
    {family:'home.tissue_case',re:/ティッシュケース/},
