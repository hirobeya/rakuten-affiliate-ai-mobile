(function(root){
  ...
  const baseRules=[
    [/レンジフード|換気扇|(?:レンジフード|換気扇).*フィルター|フィルター.*(?:レンジフード|換気扇)/,{hook:'換気扇のベタベタ掃除、できれば何度もやりたくない…',bridge:'そんな「掃除の手間を少しでも減らしたい」に合うのが、このアイテム。',points:['汚れ対策を先回りしたい','大がかりな掃除の回数を減らしたい','手軽に取り入れられる対策を探している'],benefit:'汚れ対策を先回りしたい人にぴったり',audience:'換気扇まわりの掃除をラクにしたい人'}],
    ...
    [/おむつ|消臭袋|防臭袋|(?:生ゴミ|ごみ|ゴミ).*(?:防臭|消臭)|(?:防臭|消臭).*(?:生ゴミ|ごみ|ゴミ)/,{hook:'ゴミ箱を開けた瞬間のニオイ、毎日のことやから気になる…',bridge:'おむつや生ゴミのニオイ対策を、できるだけ簡単に済ませたい人に。',points:['ゴミ箱まわりのニオイが気になる','手軽な防臭対策を探している','毎日使いやすいものを選びたい'],benefit:'ニオイ対策を手軽に続けたい人にぴったり',audience:'ゴミ箱まわりのニオイを手軽に抑えたい人'}],
    [/段ボール|ダンボール|開梱|荷ほどき|箱開け|開封(?:用|カッター|オープナー)|梱包カッター/,{hook:'ネット通販の段ボール、開けるたびにハサミを探すの面倒…',bridge:'届いた荷物をサッと開けたい人に、あると地味に助かるアイテム。',points:['開封作業を早く済ませたい','ハサミを探す手間をなくしたい','毎日使える小さな便利グッズが好き'],benefit:'荷物の開封をサッと済ませたい人にぴったり',audience:'通販の荷物をサッと開封したい人'}],
    ...
    [/掃除|清掃|クリーナー|掃除ブラシ|清掃ブラシ|ワイパー|モップ|ダスター/,{hook:'毎日の掃除、できればもっと短時間で終わらせたい…',bridge:'気づいたときにサッと使えて、掃除を後回しにしにくいアイテム。',points:['掃除時間を短くしたい','準備や片付けが少ないものがいい','こまめに使いやすいものを探している'],benefit:'掃除時間を短くしたい人にぴったり',audience:'掃除を短時間で済ませたい人'}],
    [/フライパン|炒め鍋|中華鍋|片手鍋|両手鍋|雪平鍋|行平鍋|三徳包丁|ペティナイフ|パン切り包丁/,{hook:'毎日の料理、使う道具が合わないと小さなストレスが積み重なる…',bridge:'焼く・煮る・切るなど、用途に合う調理道具で作業をスムーズにしたい人に。',points:['用途に合う調理道具を選びたい','毎日の調理をスムーズにしたい','使いやすいサイズや形を選びたい'],benefit:'用途に合う調理道具を選びやすい',audience:'毎日の調理を使いやすい道具で進めたい人'}],
  ...
  function painContext(name,keyword){
    ...
    // Accuracy first: never infer a product's use only from the search keyword.
    // Rakuten search can return adjacent products, so keyword-only matching can create false claims.
