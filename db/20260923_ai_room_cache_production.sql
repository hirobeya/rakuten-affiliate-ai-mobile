-- Production AI cache for Urenavi Groq fact extraction.
...
revoke all on table public.urenavi_ai_room_cache from public, anon, authenticated;
grant select, insert, update, delete on table public.urenavi_ai_room_cache to service_role;

comment on table public.urenavi_ai_room_cache is
  'Server-side Groq fact-extraction cache. Only service_role can access it; rows are reused for up to 90 days by application code.';
